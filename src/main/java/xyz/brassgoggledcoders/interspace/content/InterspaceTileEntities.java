...
public class InterspaceTileEntities {
    ...
    public static RegistryObject<TileEntityType<ObeliskControllerTileEntity>> OBELISK_CONTROLLER =
    ...
    public static RegistryObject<TileEntityType<ObeliskConnectedTileEntity>> OBELISK_CONNECTED =

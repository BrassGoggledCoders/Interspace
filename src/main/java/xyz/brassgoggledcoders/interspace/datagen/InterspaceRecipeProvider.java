...
public class InterspaceRecipeProvider extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        this.compress(InterspaceBlocks.NAFASI_BLOCK::getSecondary, InterspaceItemTags.INGOTS_NAFASI, consumer);
        this.compress(InterspaceItems.NAFASI_INGOT, InterspaceItemTags.NUGGETS_NAFASI, consumer);
    }

    protected void decompress(Supplier<? extends IItemProvider> output, ItemTags.Wrapper input, Consumer<IFinishedRecipe> consumer) {
    ...
    protected void compress(Supplier<? extends IItemProvider> output, ItemTags.Wrapper input, Consumer<IFinishedRecipe> consumer) {
